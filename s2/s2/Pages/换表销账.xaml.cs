...
{
    public partial class 换表销账 : UserControl
    {
        String jsonjs = "";
        String jsontb = "";
        String url = "";
        ...
        {
            int lastreading = int.Parse(lastinputgasnum.Text);
            int reading = int.Parse(lastinputgasnum_cb.Text);
            var pregas = reading - lastreading;
