...
{
    public partial class 抄表册管理 : UserControl
    {
        ...
        private void saveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (GeneralObject go in list)
            {
                ...
                //产生要发送后台的JSON串
                json += ("{userid:" + go.GetPropertyValue("f_userid") + ",reading:" + lastrecord + ",lastreading:" +lastinputnum + ",stairType:" + stairType + ",pregas:" + pregas+ ",id:" + id + "}");
            }
            ...
            String str = meter.SelectedValue.ToString();
            string uri = wci.BaseAddress + "/handcharge/record/batch/" + "/" + chaobiaoriqi.SelectedDate +"/" +meter.SelectedValue.ToString() + "?uuid=" + System.Guid.NewGuid().ToString();
        ...
        private void daninfos_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
