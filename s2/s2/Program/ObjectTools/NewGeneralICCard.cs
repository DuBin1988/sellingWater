...
namespace Com.Aote.ObjectTools
{
    ...
    public class NewGeneralICCard : CustomTypeHelper, IAsyncObject
    {
        ...
        #region CanSellGas 是否可以售水
        //是否可以售水，售水完成后，要自动转换成否
        ...
        public void SellGas()
        {
            ...
            client.DownloadStringAsync(new Uri("http://127.0.0.1:8000/WriteGasCard" + 
                            ...
                            "&kh=" + CardId +          //卡号
                            "&dqdm=" + Dqdm +        //地区代码，从水表管理里取
                            "&ql=" + Gas +          //水量
                            "&csql=" + Scql +         //上次购水量，有些表需要传
                            "&ccsql=" + Sscql +        //上上次购水量，有些表需要传
                            "&cs=" + BuyTimes +           //购水次数
                            "&ljgql=" + Ljgql +        //当前表累计购水量
                            "&bjql=" + Bjql +         //报警水量
                            "&czsx=" + Czsx +         //充值上限，可以在水表管理中设置
                            "&tzed=" + Tzed +         //透支额度，可以在水表管理中设置
                            "&sqrq=" + Sqrq +        //售水日期，格式为YYYYMMDD
                            "&cssqrq=" + Scsqrq +     //上次售水日期，格式为YYYYMMDD
